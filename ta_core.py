...
Pure TA logic: fetches OHLCV via yfinance, computes indicators, scores
signals, and renders a human-readable report. No CLI, no AI, no I/O
beyond the yfinance fetch.
"""
